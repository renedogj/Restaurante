...
class MyCartAdapter(private val context: Context, private val cartModelList:List<CartModel>) :
    ...
    override fun onBindViewHolder(holder: MyCartViewHolder, position: Int) {
        ...
        holder.btnDelete!!.setOnClickListener {_ ->
            val dialog = AlertDialog.Builder(context)
                .setTitle("Descartar producto")
                .setMessage("¿Realmente quieres borrar el producto seleccionado?")
